...
class ElevatorSubsystemV2Test {
    ...
    void getRequests() throws IOException {
        ...
        ElevatorSubsystemV2 testElevator = new ElevatorSubsystemV2(19505, 101);
    ...
    void moveElevator() throws IOException, InterruptedException {
        ElevatorSubsystemV2 e1 = new ElevatorSubsystemV2(    19507, 19509);
    ...
    void moveElevatorUntilFailure() throws IOException{
        ElevatorSubsystemV2 e1 = new ElevatorSubsystemV2(    19510, 19511);
